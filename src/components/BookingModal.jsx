...
//   const handleBook = () => {
//     alert(`Booked ${seats} seats for ${movie.name}`);
//     onClose();
//   };
...
//         <p>Rating: ⭐ {movie.rating} | ❤️ {movie.likes}</p>
//         <Form>
//           <Form.Group className="mb-3">
//             <Form.Label>Number of Seats</Form.Label>
//             <Form.Control type="number" min="1" value={seats} onChange={(e) => setSeats(e.target.value)}/>
//           </Form.Group>
//         </Form>
//       </Modal.Body>
//       <Modal.Footer>
